...
settings-resource-saved = Operation completed. Reload existing sessions manually.
...
settings-resource-register = Add local skill
...
settings-resource-open = View / edit
settings-resource-delete = Move to trash
settings-resource-save = Save text
settings-resource-readonly = This resource is read-only. Update or remove packaged resources through their package; edit external resources at their original location.
...
settings-system-prompt-help = SYSTEM.md replaces the default system prompt; APPEND_SYSTEM.md adds personal instructions. Reload existing sessions manually after saving.
settings-package-counts = Extensions { $extensions } · Skills { $skills } · Templates { $prompts } · Themes { $themes }
settings-skill-search = Search skills by name or description
settings-about-gupi = Gupi version
settings-about-pi = Pi version
settings-about-path = Resolved Pi path
settings-about-status = Pi probe status
settings-about-unavailable = Not available yet
settings-editor-discard = Discard unsaved text changes?
settings-resource-close = Back to list
...
settings-package-heading = Pi packages
settings-extension-heading = Extensions
settings-template-heading = Command templates
settings-system-heading = System prompts
settings-package-open = Open package directory
