...
recovery-startup-title = No se pudo iniciar Gupi
error-instance-startup = Comprueba los permisos de la carpeta de configuración o cierra las otras instancias de Gupi en ejecución y vuelve a intentarlo.
...
conversation-plugin-message = Mensaje del complemento
conversation-session-info-command = Información de la conversación…
conversation-session-info-title = Información de la conversación
conversation-session-info-identity = Identidad y ubicación
conversation-session-info-name = Conversación
conversation-session-info-id = ID de sesión de Pi
conversation-session-info-directory = Directorio de trabajo
conversation-session-info-file = Archivo de sesión
conversation-session-info-not-saved = Aún no se ha guardado
conversation-session-info-runtime = Configuración de ejecución
conversation-session-info-model = Modelo
conversation-session-info-thinking = Nivel de razonamiento
conversation-session-info-usage = Uso
conversation-session-info-input = Tokens de entrada
conversation-session-info-output = Tokens de salida
conversation-session-info-cache-read = Lecturas de caché
conversation-session-info-cache-write = Escrituras de caché
conversation-session-info-cost = Coste indicado por Pi
conversation-session-info-context = Contexto actual (tokens / ventana / uso)
conversation-session-info-context-value = { $tokens } de { $window } tokens ({ $percent })
conversation-session-info-counts = Estadísticas de la conversación
conversation-session-info-user-messages = Mensajes del usuario
conversation-session-info-assistant-messages = Mensajes del asistente
