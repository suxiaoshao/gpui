...
field-required-capabilities = Required Capabilities
...
capability-image-input = Image input
capability-image-generation = Image generation
capability-file-input = File input
capability-audio-input = Audio input
capability-tool-calling = Tool calling
capability-hosted-web-search = Hosted web search
capability-remote-mcp = Remote MCP
capability-reasoning = Reasoning
capability-structured-output = Structured output
capability-stateful-response-continuation = Stateful response continuation
...
notify-shortcut-trigger-template-unavailable-title = Shortcut Template Unavailable
...
template-required-capabilities-none = No required capabilities
template-compatibility-compatible = Compatible
template-compatibility-incompatible = Incompatible
template-missing-capabilities = Missing capabilities
chat-template-incompatible = Selected template is incompatible with the current model
...
shortcut-settings-description = Manage global shortcuts that send selected text, clipboard text, or screenshots to a temporary conversation.
...
shortcut-status-template-unavailable = Template Unavailable
...
shortcut-status-message-template-unavailable = The configured template could not be loaded.
shortcut-status-message-capability-mismatch = Missing required capabilities
...
shortcut-form-capability-warning = This shortcut can be saved, but it will not run with the selected model
...
shortcut-input-screenshot-description = Send image when supported, otherwise OCR text
shortcut-screenshot-input-label = Screenshot
notify-shortcut-trigger-capability-mismatch-title = Shortcut Capability Mismatch
notify-shortcut-trigger-capability-mismatch-message = Missing required capabilities
