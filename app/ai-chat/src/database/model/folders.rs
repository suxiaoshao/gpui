...
impl SqlFolder {
    ...
    pub fn path_exists(path: &str, conn: &mut SqliteConnection) -> AiChatResult<bool> {
    ...
    pub fn migration_save(data: Vec<SqlFolder>, conn: &mut SqliteConnection) -> AiChatResult<()> {
