...
provider model listing API。尚未完成 manual model editor、DB-backed composer model picker、
...
8. 再把 ChatForm model picker 从 preview data 切到 DB-backed enabled provider models。
