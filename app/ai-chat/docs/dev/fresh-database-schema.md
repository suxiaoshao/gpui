...
- 新增 `crates/ai-chat-db`，实现 `ai_chat_fresh.sqlite3`、内部 `schema_metadata` / `schema_migrations`、fresh schema、Diesel-backed bootstrap、typed repositories、FTS 同步和 provider model cache upsert。
