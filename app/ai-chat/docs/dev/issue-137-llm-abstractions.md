...
- #159 详细 UI/壳/本机状态/可观测性/legacy mapping 清单见 `app/ai-chat/docs/dev/issue-159-ai-chat2-ui.md`。该文档把每项能力标为“已完成”、“占位”、“后端已具备”、“已有专项计划”、“未开始”、“暂不做”、“不照搬”或“已替代”，避免把占位入口误判为已完成业务能力。Agent Conversation Page 首版实现和剩余缺口见 `app/ai-chat/docs/dev/issue-159-ai-chat2-agent-conversation-page.md`；Temporary Conversation Window 首版实现和剩余缺口见 `app/ai-chat/docs/dev/issue-159-ai-chat2-temporary-window.md`；ChatForm 多模态输入实现记录见 `app/ai-chat/docs/dev/issue-159-ai-chat2-chat-form-multimodal.md`；Skill Settings 实现记录见 `app/ai-chat/docs/dev/issue-159-ai-chat2-skill-settings.md`；内置工具和审批计划见 `app/ai-chat/docs/dev/issue-159-ai-chat2-built-in-tools-approval.md`。
...
- 2026-06-13 本地开发实现追加：`app/ai-chat/docs/dev/issue-159-ai-chat2-chat-form-multimodal.md` 已从计划更新为第一版实现记录。ChatForm 已实现文件/图片附件 strip、GPUI clipboard files/image paste、`+` 附件菜单、GPUI `ExternalPaths` 文件拖拽到 ChatForm、Codex app reference 样式常量、attachments 表复用、capability/runtime gating、图片 app 内 preview、macOS Finder 级 Quick Look file preview fallback、i18n/icons；`ai-chat-agent` history 已把 image/PDF/text-like file attachments 合成为 Rig user multimodal content。provider file upload、audio/generated output 和完整 rich multimodal timeline 仍留后续。
...
- 详细清单和旧 `app/ai-chat` 对比见 `app/ai-chat/docs/dev/issue-159-ai-chat2-ui.md`；agent conversation page 的 implementation-ready 计划见 `app/ai-chat/docs/dev/issue-159-ai-chat2-agent-conversation-page.md`；temporary window 的实现记录见 `app/ai-chat/docs/dev/issue-159-ai-chat2-temporary-window.md`，其模块计划禁止 Temporary 横向依赖 Home feature；Prompt Settings 计划见 `app/ai-chat/docs/dev/issue-159-ai-chat2-prompt-settings.md`；Skill Settings 计划见 `app/ai-chat/docs/dev/issue-159-ai-chat2-skill-settings.md`；Shortcut Settings 计划见 `app/ai-chat/docs/dev/issue-159-ai-chat2-shortcut-settings.md`；ChatForm 多模态输入实现记录见 `app/ai-chat/docs/dev/issue-159-ai-chat2-chat-form-multimodal.md`；内置工具和审批计划见 `app/ai-chat/docs/dev/issue-159-ai-chat2-built-in-tools-approval.md`。
