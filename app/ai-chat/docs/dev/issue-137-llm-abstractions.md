...
| #159 | `codex/issue-159-ai-chat2-ui` | 在 `app/ai-chat2` 渲染项目、对话、多步 reasoning、tool、approval、多模态 timeline | 进行中：子分支已包含基础设施壳、app chrome、About、Sidebar/home skeleton 和 Home root/sidebar 结构修正；尚未合入集成分支；暂无 PR |
