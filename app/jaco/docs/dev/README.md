...
| [#189](https://github.com/suxiaoshao/gpui/issues/189) Agent 消息单次请求用量 | `In progress`；action row HoverCard 与 live/reload projection 已实施并通过本地验证，真实 provider 请求与三平台 CI 待验证 | [issue-189/README.md](issue-189/README.md) |
