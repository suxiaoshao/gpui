...
- [Issue #215：依赖升级](issue-215/README.md)：jaco 的依赖/API 配套迁移与验证边界。
...
| [#196](https://github.com/suxiaoshao/gpui/issues/196) provider 生成图片 managed storage 与恢复 | `Implemented locally`；Jaco owner 已实现 database-target 注入、batch adapter、stable attachment ID 与 startup orphan reconciliation | [issue-196/README.md](issue-196/README.md) |
