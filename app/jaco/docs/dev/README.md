...
| [#188](https://github.com/suxiaoshao/gpui/issues/188) 侧边栏项目与对话上下文菜单 | `In progress`；shared actions、project 双菜单入口、conversation 右键菜单与 pin/archive 直接按钮、rename/archive publication、runtime fence、clipboard、icons 与 Fluent 已在本地实现，人工 UI/远端 CI 待验证 | [issue-188/README.md](issue-188/README.md) |
