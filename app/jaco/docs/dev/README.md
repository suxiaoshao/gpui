...
| [#195](https://github.com/suxiaoshao/gpui/issues/195) 会话时间线持久化文件附件 | `Implemented locally`；File/Attachment ordered projection、Audio compatibility 与 safe open/reveal/save 已实现并通过本地验收，远端 CI、commit 和 PR 待执行 | [issue-195/README.md](issue-195/README.md) |
