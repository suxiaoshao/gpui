...
| [#199](https://github.com/suxiaoshao/gpui/issues/199) 显式 form owner API | 已实施；Jaco 355 个测试、合并 clippy 与定向 bundle/UI smoke 通过，MCP 删除交互由自动化覆盖 | [issue-199/README.md](issue-199/README.md) |
