...
use jaco_db::{DbError, FreshRepository, NewPrompt, PromptRecord, UpdatePrompt};
...
pub(crate) fn init(cx: &mut App) -> jaco_db::Result<()> {
...
pub(crate) fn delete_prompt(cx: &mut App, id: &PromptId) -> jaco_db::Result<usize> {
...
fn sync_from_repository(cx: &mut App) -> jaco_db::Result<()> {
