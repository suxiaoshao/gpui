...
| [#189](https://github.com/suxiaoshao/gpui/issues/189) Jaco 消息请求用量、输入框上下文占用与时间范围统计 | `In progress`；Agent消息、composer 与 Settings 工作包均已实施，最终人工与 CI 门待做 | [issue-189/README.md](issue-189/README.md) |
