...
| [#189](https://github.com/suxiaoshao/gpui/issues/189) Jaco 消息请求用量、输入框上下文占用与时间范围统计 | `In progress`；Agent 消息单次请求用量已实施，composer 正在实施，Settings 计划仍为 `Draft` | [issue-189/README.md](issue-189/README.md) |
