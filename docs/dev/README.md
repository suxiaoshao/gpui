...
| [#188](https://github.com/suxiaoshao/gpui/issues/188) Jaco 侧边栏项目与对话上下文菜单 | `In progress`；本地实现与自动化门已完成，人工 UI 矩阵受启动期文件监听阻塞，远端 CI 待提交后验证 | [issue-188/README.md](issue-188/README.md) |
