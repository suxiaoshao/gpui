...
macro_rules! define_form_text_control {
    ($control:ident, $state:ty) => {
        pub struct $control {
            #[allow(dead_code)]
...
define_form_text_control!(FormInput, InputState);
define_form_text_control!(FormTextarea, TextareaState);
define_form_text_control!(FormEditor, EditorState);
