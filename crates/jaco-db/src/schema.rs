...
diesel::table! {
    provider_steps (id) {
        ...
        continuation_kind -> Nullable<Text>,
        provider_response_id -> Nullable<Text>,
        reasoning_context -> Nullable<Text>,
        continuation_expires_at -> Nullable<TimestamptzSqlite>,
        continuation_invalidated_at -> Nullable<TimestamptzSqlite>,
        continuation_error_json -> Nullable<Json>,
        settings_snapshot_json -> Json,
        error_json -> Nullable<Json>,
        created_at -> TimestamptzSqlite,
        started_at -> Nullable<TimestamptzSqlite>,
