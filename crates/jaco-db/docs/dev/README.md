...
| [#196](https://github.com/suxiaoshao/gpui/issues/196) stable attachment ID 与 prelinked entry batch | `Ready`；caller-assigned ID、ordered entry/attachment transaction 与 generated-file index 已设计，schema 保持不变 | [issue-196/README.md](issue-196/README.md) |
