...
pub(crate) struct PersistenceContext {
    ...
    last_completed_provider_step_id: Arc<Mutex<Option<ProviderStepId>>>,
    provider_outputs: Arc<Mutex<HashMap<ProviderStepId, Vec<ProviderRawPayload>>>>,
...
impl PersistenceContext {
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            last_completed_provider_step_id: Arc::new(Mutex::new(None)),
            provider_outputs: Arc::new(Mutex::new(HashMap::new())),
