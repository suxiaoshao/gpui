...
- [Issue #215：依赖升级](issue-215/README.md)：jaco-agent 的依赖/API 配套迁移与验证边界。

这里登记 `crates/jaco-agent` owner 的实施级计划。跨 owner 状态、共享契约、顺序和聚合完成证据由 workspace root plan 持有。
...
| [#196](https://github.com/suxiaoshao/gpui/issues/196) OpenRouter assistant image ingestion | `Implemented locally`；动画全帧预解码已移除，编码文件大小、画布、首帧边界与本地基准已完成 | [issue-196/README.md](issue-196/README.md) |
