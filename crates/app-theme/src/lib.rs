...
const CHART_1_SEED_COLOR: Argb = Argb::from_rgb(0x3B, 0x82, 0xF6);
const CHART_2_SEED_COLOR: Argb = Argb::from_rgb(0x06, 0xB6, 0xD4);
const CHART_3_SEED_COLOR: Argb = Argb::from_rgb(0x63, 0x66, 0xF1);
const CHART_4_SEED_COLOR: Argb = Argb::from_rgb(0x8B, 0x5C, 0xF6);
const CHART_5_SEED_COLOR: Argb = Argb::from_rgb(0xD9, 0x46, 0xEF);
